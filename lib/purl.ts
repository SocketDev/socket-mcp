...
export function buildPurl(
  ...
  // `1.0.0` is a stale model-default for ecosystems where the model didn't know
  // the version (npm/pypi historically). For ecosystems whose extensions/packages
  // genuinely publish 1.0.0 (e.g. openvsx, chrome), treat it as a real version.
